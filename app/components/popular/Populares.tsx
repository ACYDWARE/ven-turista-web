...
const Populares = () => {
  return (
    <div className='w-screen h-[800px] bg-primary overflow-hidden -mt-2 flex flex-col items-center'>
      <h1 className='mt-4 font-bold tracking-widest text-xl lg:text-5xl mx-[1rem] text-justify'>POPULARES</h1>
